    ...
    <>
      <div class="detail-user">
        <div class="detail-user-info">
          <div>
            <h2 class="detail-h2">Kia And Rob 님이 호스팅하는 집 전체</h2>
        ...
        <div class="detail-special">
          <div class="special-thing">
            ...
            <div class="space">
              <div class="space-font-top">업무 전용 공간</div>
              <div class="space-font-bottom">
          ...
          <div class="special-thing">
            ...
            <div class="space">
              <div class="space-font-top">Kia And Rob님은 슈퍼호스트입니다</div>
              <div class="space-font-bottom">
          ...
          <div class="special-thing-bottom">
            <div class="">
              <MedalSvg
                viewBox="0 0 32 32"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="space">
              <div class="space-font-top">
                11월 30일 오전 3:50 전까지 무료로 취소하실 수 있습니다.
              </div>
              <div class="space-font-bottom"></div>
            </div>
          </div>
        </div>
        ...
        <div>
          <section>
            <div class="section-div">
              ...
              <button type="button" class="section-btn">
                더 알아보기
              </button>
            </div>
          </section>
        ...
        <div class="user-cmt">
          ...
          <div class="user-btn">
            <button class="user-btn-style">
              <span class="section-btn">더 보기</span>
              <span class="user-svg">
                <SeeMoreSvg
                  viewBox="0 0 18 18"
                  role="presentation"
