...
import { loginOn, onTrue } from "../recoil/airplane";
    ...
    <NavBar value={on}>
      ...
      <SearchWrap>
        <NavSearch value={on} onClick={SearchBtn}>
          ...
          <span className="nav_search_span"></span>
          <button className="nav_search_btn">
            <div className="nav_search_div">언제든 일주일</div>
          </button>
          <span className="nav_search_span"></span>
          <button className="nav_search_btn">
            <div className="nav_search_div guest">게스트 추가</div>
      ...
      <Profile>
        ...
        >
          ...
          <ProfileLogin value={profile}>
            <ul style={{ padding: "5px 0" }}>
              <ProfileLi onClick={handleLogin} style={{ fontWeight: "500" }}>
                회원 가입
              </ProfileLi>
              <ProfileLi onClick={handleLogin}>로그인</ProfileLi>
            </ul>
            <ul style={{ borderTop: "1px solid #dddddd", padding: "5px 0" }}>
              <ProfileLi>당신의 공간을 에어비앤비하세요</ProfileLi>
              <ProfileLi>체험 호스팅하기</ProfileLi>
              <ProfileLi style={{ paddingBottom: "5px" }}>도움말</ProfileLi>
            </ul>
          </ProfileLogin>
        </ProfileDetail>
      </Profile>
