      ...
      <header>
        ...
        <div className="request">
          <div className="request-con">
            ...
            <h2 className="request-h2">예약 요청</h2>
          </div>
        </div>
      </header>
      <main>
          ...
          <div className="main-left">
            <div className="side-info">
              <div className="side-info-div">
                <h2 className="side-info-h2 left-h2">저렴한 요금</h2>
                <span>
            ...
            <div className="sticky-right">
              <div className="side-bar">
                <div className="side-blk">
                  <div className="right-img-box">
                    <div className="right-img">
                      <img
                        ...
                        src={detail.src}
                        data-original-uri="https://a0.muscache.com/im/pictures/miso/Hosting-749996089802009824/original/e17c9704-68e8-478b-90ce-86e822ef921b.jpeg?aki_policy=large"
                      />
                    </div>
                    <div className="right-info">
                      <div>
                        <div className="right-house">집 전체</div>
                      ...
                      <div className="right-star">
                        ...
                        <div>{detail.star} (후기 7개) • 슈퍼호스트</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="main-right-mny">요금 세부정보</div>
                  ...
                  <div className="side-allcal">
                    <div className="side-cal">
                      <div>총 합계</div>
                      <div>
                        ₩{makeCash(money * 5 + clean + service + tax)}원
                      </div>
                    </div>
                  </div>
                </div>
